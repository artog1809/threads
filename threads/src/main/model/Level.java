...
//        knots.add(knot10);
        ...
        Knot knot1 = new DistanceKnot(new Point(12,20), ball);
        knots.add(knot1);

        Knot knot2 = new DistanceKnot(new Point(2,8), ball);
        knots.add(knot2);

        Knot knot3 = new Knot(new Point(5,15));
        knots.add(knot3);

        Knot knot4 = new Knot(new Point(10,5));
        knots.add(knot4);
//        Knot knot3 = new Knot(new Point(3,3));
//        knots.add(knot3);
        return knots;
    }
...
//        threads.add(thread20);
        ...
        Thread thread2 = new Thread(ball.getKnots().get(2),ball.getKnots().get(3));
        threads.add(thread2);

        Thread thread3 = new Thread(ball.getKnots().get(0),ball.getKnots().get(2));
        threads.add(thread3);
